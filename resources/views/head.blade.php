...
$theme_colors = maincontroller::theme_color();
foreach ($theme_colors as $key => $value) {


    $organization =  $value->company_name;

    $theme_color =  $value->theme_color;
    $text_color = $value->text_color;
    $text_hover_color = $value->text_hover_color;
}
            ...
            <ul class="list-unstyled navbar__list">
                <li class="active has-sub">
                    <a class="js-arrow" href="#">
                        <i class="fas fa-user"></i>{{session('user_id')['username']}}
                        <span class="arrow">
                    ...
                    <ul class="list-unstyled navbar__sub-list js-sub-list">
                        <li>
                            <a href="index.html">
                                <i class="fas fa-user"></i>Dashboard 1</a>
                        </li>
                        <li>
                            <a href="/users">
                                <i class="fas fa-user"></i>Dashboard 2</a>
                        </li>
                        <li>
                            <a href="index3.html">
                                <i class="fas fa-user"></i>Dashboard 3</a>
                        </li>
                        <li>
                            <a href="/sellers">
                                <i class="fas fa-user"></i>/sellers</a>
                        </li>
                    </ul>
                </li>
                <li>
...
<!-- <aside class="menu-sidebar2">
    <div class="logo">
        <a href="#" style="color: white;">
            Made By <span>Psoft</span>
        </a>
    </div>
    <div class="menu-sidebar2__content js-scrollbar1 ps ps--active-y">
        <div class="account2">

            <h4 class="name">{{session('user_id')['username']}}</h4>
            <a>Role: {{session('user_id')['role']}}</a>
            <br>
            ...
            <ul class="list-unstyled navbar__list">
                <li class="active has-sub">
                    ...
                    <ul class="list-unstyled navbar__sub-list js-sub-list">
                        <li>
                            <a href="/customize">
                                <i class="fas fa-user"></i>Customize</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="/sellers">
                                <i class="fas fa-user"></i>Suppliers</a>
                        </li>
                    </ul>
                </li>
                <li>
        ...
        <div class="ps__rail-y" style="top: 0px; height: 189px; right: 0px;">
...
<header class="header-desktop3 d-none d-lg-block">
    <div class="section__content section__content--p35">
        <div class="header3-wrap">
            <div class="header__logo">
                <a href="#" style="color:<?php echo $theme_color; ?>;">
                ...
                <ul class="list-unstyled">
                    <li class="has-sub">
                        ...
                        <ul class="header3-sub-list list-unstyled">
                            ...
                            <li>
                                <a href="/warehouse">
                                    <i class="fas fa-user"></i>warehouse</a>
                            </li>
                            <li>
                                <a href="/zone">
                                    <i class="fas fa-user"></i>zone</a>
                            </li>
                            <li>
                                <a href="/sales_officer">
                                    <i class="fas fa-user"></i>Sales Officer</a>
                            </li>
                        </ul>
                    ...
                    <li class="has-sub">
                        <a href="#">
                            <i class="far fa-check-square"></i>Invoice
                            <span class="bot-line"></span>
                        </a>
                        <ul class="header3-sub-list list-unstyled">
                            ...
                            <li class="has-sub">
                                <a class="js-arrow" href="#">
                                    <i class="fas fa-user"></i>Purchase Invoice
                                </a>
    ...
    flex-direction: column;">
                            ...
                            <li class="has-sub">
                                <a class="js-arrow" href="#">
                                    <i class="fas fa-user"></i>Sell Invoice
                                </a>
                                <ul class="list-unstyled navbar__sub-list js-sub-list   li" style="display: none;
    flex-direction: column;">
                            ...
                            <li>
                                <a href="/sale-invoice">
                                    <i class="fas fa-user"></i>Sale invoices
                                </a>
                            </li>
                            <li>
                                <a href="/sellers">
                                    <i class="fas fa-user"></i>Suppliers
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="has-sub">
                        ...
                        <ul class="header3-sub-list list-unstyled">
                            <li>
                                <a href="" data-toggle="modal" data-target="#p-user">
                                    <i class="fas fa-user"></i>Users</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="" data-toggle="modal" data-target="#p-buyer">
                                    <i class="fas fa-user"></i>Buyer</a>
                            </li>
                        </ul>
                    ...
                    <li class="has-sub">
                        ...
                        <ul class="header3-sub-list list-unstyled">
                            <li>
                                <a href="/account_account=1">Chart Of Accounts</a>
                            </li>
                            <li>
    ...
    <nav class="navbar-mobile">
        <div class="container-fluid">
            <ul class="navbar-mobile__list list-unstyled">
                ...
                <li class="has-sub">
                    <a class="js-arrow" href="#">
                        <i class="fa fa-user"></i>Invoice</a>
                    <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                        <li class="has-sub">
