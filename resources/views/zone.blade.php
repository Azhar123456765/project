                ...
                <div class="modal-body">
                    <form method="POST" action="/add_zone">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="company" name="zone_name" placeholder="company" required>
                        </div>
...
<div class="modal fade" id="edit_modal{{$row->zone_id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                ...
                <div class="modal-body">
                    <form method="POST" action="/edit_zone{{$row->zone_id}}">
                        ...
                        <div class="form-group">
                            <label for="username">Zone Name</label>
                            <input type="text" class="form-control" id="company" name="zone_name" placeholder="company" required value="{{$row->zone_name}}">
                        </div>
